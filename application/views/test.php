                ...
                <div class="col-lg-6">
                	<div class="card">
                            <div class="card-body">
                                ...
                                <?php foreach($package_setup as $key=>$psdata): $count=1?>
                                <div class="m-t-20">
                                    <div class="d-flex no-block align-items-center">
                                        <span>81% <?php echo $psdata['package_name']?></span>
                                        <div class="ml-auto">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped <?php
                                         ...
                                         ?>" role="progressbar" style="width: 81%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
